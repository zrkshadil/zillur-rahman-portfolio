...
export const YouTubeIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const SocialIcon = ({ name, className = "w-5 h-5", ...props }) => {
  const IconComponent = socialIconMap[name?.toLowerCase()];
